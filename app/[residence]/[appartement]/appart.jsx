    ...
    <div className="flex-col xl:flex-col md:flew-row px-4 pb-4">
      ...
      <div className="embla" ref={emblaRef}>
          <div className="embla__container">
            ...
            <div className="embla__slide"><Avatar url={b1i} width={200} height={600} classn={classna} /></div>
            <div className="embla__slide"><Avatar url={b1i} width={200} height={600} classn={classna} /></div>
          </div>
          <div className="flex flex-row justify-between  ">
        
          <button className="embla__prev absolute top-20 right-8 p-2 rounded-lg bg-white/70" onClick={scrollPrev}>
            Next
          </button>
          <button className="embla__next embla__prev absolute top-20 left-8 p-2 rounded-lg bg-white/70" onClick={scrollNext}>
            Prev
          </button>
      ...
      <div className="py-4 flex flex-col gap4 bg-white mt-4 px-4 rounded-lg">
        <p className="text-2xl font-extrabold pt-4 pb-2">{b1}</p>
