...
export default function Foot() {
  return (
    <footer className="bg-gray-300 flex py-4 border-t-1 border-gray-500 xl:px-12 px-4  xl:gap-10 gap-2 ">
      <div className="flex flex-col xl:gap-2 justify-start items-start border-r-1 border-black xl:pr-4 pr-2 ">
      ...
      <div className="flex flex-col justify-between xl:border-black xl:pr-4 pr-2 xl:border-r-1 text-center w-full">
        <div>
