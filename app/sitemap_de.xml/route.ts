...
const SEG_DE = "Projet";   // ⬅️ change en "Projekt" si route DE localisée
const SEG_FR = "Projet";
const SEG_EN = "Project";

const PATHS = {
  [LANG]: { root: "", projects: "/Projet/List", detail: (slug: string) => `/${SEG_DE}/Detail/${slug}` },
...
function altLinksStatic(key: "root" | "projects") {
  const links = (INDEXABLE as readonly ("de"|"fr"|"en")[])
