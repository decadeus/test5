...
export default function Chatbot() {
  ...
  return (
    <div className="fixed bottom-0 right-0 w-[100vw] max-w-[100vw] left-0 -translate-x-0 sm:bottom-10 sm:right-10 sm:left-auto sm:translate-x-0 sm:w-[380px] sm:max-w-[95vw] bg-slate-50 rounded-t-2xl sm:rounded-[32px] shadow-2xl z-[1000] flex flex-col overflow-hidden font-sans">
