...
export default function PecherPologneGuide() {
  ...
  const jsonLd = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://hoomge.com/${currentLocale}/blog/10`
    },
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  <strong>Astuce :</strong> Si vous n'avez pas encore de <Link href={`/${currentLocale}/blog/5`} className="text-blue-600 hover:text-blue-800 underline">PESEL</Link>, vous pouvez obtenir un permis temporaire avec votre passeport, mais il faudra le régulariser rapidement.
                </p>
              </div>
            </div>
          </div>
