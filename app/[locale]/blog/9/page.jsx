...
export default function ArticlePage() {
  ...
  const jsonLd = {
    ...
    keywords: 'logement Pologne, loyer Varsovie, meldunek, transport Pologne, czynsz, kaucja, appartement Piaseczno, PKP Intercity, PESEL, expatriation Pologne, guide pratique 2025',
    wordCount: 1800,
    ...
    about: [
      ...
      },
      {
        '@type': 'Place',
        name: 'Varsovie',
        description: 'Capitale de la Pologne'
      },
      {
        '@type': 'Place', 
        name: 'Piaseczno',
        description: 'Ville proche de Varsovie'
      }
    ]
  };
  ...
  return (
    <>
      ...
      <ArticleLayout
        ...
        imageAlt="Se loger en Pologne - Guide pratique"
      >
